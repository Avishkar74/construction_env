...
Fixes vs original:
  - Hard mode tasks 11–18 now have realistic material dependencies
  - tiles added to starting_materials for medium/hard
"""
...
def get_task_config(difficulty: str) -> List[Dict[str, Any]]:
    ...
    easy = [
        ...
        {
            "task_id": 5, "title": "Finishing",
            "description": "Interior finishing and paint",
    ...
    medium = easy + [
        {
            "task_id": 6, "title": "Electrical Rough-In",
            "description": "Install wiring conduits",
            "planned_start": 14, "planned_end": 26, "dependencies": [2],
            "required_workers": 3, "required_materials": {},
            "is_critical_path": False, "priority": "high",
        },
        {
            "task_id": 7, "title": "Plumbing",
            "description": "Install pipes and drainage",
            "planned_start": 14, "planned_end": 28, "dependencies": [2],
            "required_workers": 3, "required_materials": {},
            "is_critical_path": False, "priority": "medium",
        },
        {
            "task_id": 8, "title": "Windows & Doors",
            "description": "Install frames and fixtures",
            "planned_start": 22, "planned_end": 32, "dependencies": [3],
            "required_workers": 3, "required_materials": {},
            "is_critical_path": False, "priority": "medium",
        },
        {
            "task_id": 9, "title": "Electrical Fitting",
            "description": "Install switches, sockets, panels",
            "planned_start": 30, "planned_end": 40, "dependencies": [6, 7],
            "required_workers": 2, "required_materials": {},
            "is_critical_path": False, "priority": "high",
        },
        {
            "task_id": 10, "title": "Final Inspection",
            "description": "Walkthrough and punch-list",
    ...
    # Hard: 18 tasks — material deps added to tasks 11–13
    hard = medium + [
        {
            "task_id": 11, "title": "HVAC Installation",
            "description": "Heating and cooling systems",
            "planned_start": 22, "planned_end": 36, "dependencies": [2],
            "required_workers": 3,
            "required_materials": {"steel": 5},          # ductwork steel
            "is_critical_path": False, "priority": "high",
        },
        {
            "task_id": 12, "title": "Insulation",
            "description": "Wall and roof insulation",
            "planned_start": 28, "planned_end": 38, "dependencies": [4],
            "required_workers": 2,
            "required_materials": {"timber": 8},          # insulation backing frames
            "is_critical_path": False, "priority": "medium",
        },
        {
            "task_id": 13, "title": "Flooring",
            "description": "Tile and floor finishing",
            "planned_start": 38, "planned_end": 46, "dependencies": [7, 12],
            "required_workers": 3,
            "required_materials": {"cement": 3, "tiles": 40},  # screed + tiles
            "is_critical_path": False, "priority": "medium",
        },
        {
            "task_id": 14, "title": "Landscaping",
            "description": "Garden and external works",
            "planned_start": 42, "planned_end": 52, "dependencies": [8],
            "required_workers": 3, "required_materials": {},
            "is_critical_path": False, "priority": "low",
        },
        {
            "task_id": 15, "title": "Security Systems",
        ...
        {
            "task_id": 16, "title": "Elevator Installation",
            "description": "Lift system and shaft",
            "planned_start": 20, "planned_end": 40, "dependencies": [3],
            "required_workers": 4,
            "required_materials": {"steel": 15},
            "is_critical_path": True, "priority": "critical",
        },
        {
            "task_id": 17, "title": "Fire Safety",
            "description": "Sprinklers and alarms",
            "planned_start": 40, "planned_end": 52, "dependencies": [11, 16],
            "required_workers": 2, "required_materials": {},
            "is_critical_path": True, "priority": "critical",
        },
        {
            "task_id": 18, "title": "Commissioning",
            "description": "All systems test and handover",
...
DIFFICULTY_SETTINGS: Dict[str, Dict] = {
    "easy": {
        ...
        "max_days": 180,
        "starting_materials": {
            "cement": 200, "steel": 100, "bricks": 500,
            "timber": 80, "paint": 60, "tiles": 0,
        },
    },
    "medium": {
        "total_workers": 15,
    ...
    "hard": {
        ...
        "max_days": 180,
        "starting_materials": {
            "cement": 80, "steel": 40, "bricks": 200,
            "timber": 30, "paint": 20, "tiles": 0,
        },
    },
}
