...
class WorkforceModule:
    MAX_EFFICIENCY = 1.4
    MIN_EFFICIENCY = 0.6
    FATIGUE_PER_OVERTIME = 0.15
    RECOVERY_PER_REST_DAY = 0.05
    ...
    def apply_overtime(self, hours: int):
        ...
        self.fatigue = min(1.0, self.fatigue + self.FATIGUE_PER_OVERTIME)
    ...
    def overtime_cost(self, overtime_hours: int) -> float:
        return self.total_workers * overtime_hours * 200.0  # ₹200/worker/hour
